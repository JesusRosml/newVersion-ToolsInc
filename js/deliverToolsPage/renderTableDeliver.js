import { buttonDeleteDelivery } from "./deleteToolDelivery.js";

export const renderTableDelivery = ( elementDOM, arrayID, type, brand, model, state ) => {
    ...
    arrayID.forEach( (item, idx) => {
        ...
        createButton.addEventListener('click', () => buttonDeleteDelivery( createButton, elementDOM ));
